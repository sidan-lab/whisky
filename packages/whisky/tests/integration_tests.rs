mod int_tests {
    ...
    // #[test]
    // fn test_csl_tx_parser_round_trip() {
    ...
    //     let tx_parser = TxParser::new(tx_hex, &utxos);
    //     assert!(tx_parser.is_ok());

    //     let tx_parser = tx_parser.unwrap();
    ...
    //     assert_eq!(tx_hex, tx_hex_round_trip);
    // }
}
