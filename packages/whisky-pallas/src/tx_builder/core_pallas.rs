...
impl CorePallas {
    pub fn new(params: Option<Protocol>) -> Result<CorePallas, WError> {
        Ok(CorePallas {
            tx_hex: String::new(),
...
impl CorePallas {
    pub fn add_tx_in(&mut self, input: PubKeyTxIn) -> Result<(), WError> {
        ...
        //             .map_err(WError::from_err("CorePallas - add_tx_in - invalid address"))?,
        //         &csl::TransactionInput::new(
        //             &csl::TransactionHash::from_hex(&input.tx_in.tx_hash)
        //                 .map_err(WError::from_err("CorePallas - add_tx_in - invalid tx_hash"))?,
        //             input.tx_in.tx_index,
        //         ),
        //         &to_value(&input.tx_in.amount.unwrap())?,
        //     )
        //     .map_err(WError::from_err(
        //         "CorePallas - add_tx_in - invalid regular input",
        //     ))?;
        Ok(())
    }
    ...
    pub fn add_simple_script_tx_in(&mut self, input: SimpleScriptTxIn) -> Result<(), WError> {
        ...
        //                     WError::from_err(
        //                         "CorePallas - add_simple_script_tx_in - invalid script_cbor",
        //                     ),
        //                 )?,
        //             ),
        //             &csl::TransactionInput::new(
        ...
        //                     WError::from_err(
        //                         "CorePallas - add_simple_script_tx_in - invalid tx_hash (1)",
        //                     ),
        //                 )?,
        //                 input.tx_in.tx_index,
        //             ),
        ...
        //                     WError::from_err(
        //                         "CorePallas - add_simple_script_tx_in - invalid simple_script_hash",
        //                     ),
        //                 )?,
        //                 &csl::TransactionInput::new(
        //                     &csl::TransactionHash::from_hex(&script.ref_tx_in.tx_hash).map_err(
        //                         WError::from_err(
        //                             "CorePallas - add_simple_script_tx_in - invalid tx_hash (2)",
        //                         ),
        //                     )?,
        ...
        //                 &csl::TransactionHash::from_hex(&input.tx_in.tx_hash).map_err(
        //                     WError::from_err(
        //                         "CorePallas - add_simple_script_tx_in - invalid tx_hash (3)",
        //                     ),
        //                 )?,
        //                 input.tx_in.tx_index,
        //             ),
    ...
    pub fn add_script_tx_in(&mut self, input: ScriptTxIn) -> Result<(), WError> {
        ...
        //             "CorePallas - add_script_tx_in - invalid datum.data",
        //         ))?,
        //     )),
        ...
        //                 "CorePallas - add_script_tx_in - invalid tx_hash",
        //             ))?,
        //             datum.tx_index,
        //         );
        ...
        //         "CorePallas - add_script_tx_in - invalid redeemer.data",
        //     ))?,
        //     &csl::ExUnits::new(
        //         &to_bignum(redeemer.ex_units.mem).map_err(WError::add_err_trace(
        //             "CorePallas - add_script_tx_in - invalid redeemer memory",
        //         ))?,
        //         &to_bignum(redeemer.ex_units.steps).map_err(WError::add_err_trace(
        //             "CorePallas - add_script_tx_in - invalid redeemer steps",
        //         ))?,
        //     ),
        // );
        ...
        //             "CorePallas - add_script_tx_in - invalid tx_hash (2)",
        //         ))?,
        //         input.tx_in.tx_index,
        //     ),
        //     &to_value(&input.tx_in.amount.unwrap())?,
    ...
    pub fn add_output(&mut self, output: Output) -> Result<(), WError> {
        ...
        //         WError::from_err("CorePallas - add_output - invalid output_address"),
        //     )?);
        ...
        //                     "CorePallas - add_output - invalid datum hash",
        //                 ))?,
        //             ));
        //         }
        //         Datum::Inline(data) => {
        ...
        //                 &csl::PlutusData::from_hex(&data).map_err(WError::from_err(
        //                     "CorePallas - add_output - invalid inline datum",
        //                 ))?,
        //             );
        //         }
        //         Datum::Embedded(data) => {
        //             let datum = &csl::PlutusData::from_hex(&data).map_err(WError::from_err(
        //                 "CorePallas - add_output - invalid embedded datum",
        //             ))?;
        ...
        //                     )
        //                     .map_err(WError::from_err(
        //                         "CorePallas - add_output - invalid script_cbor",
        //                     ))?,
        //                 ))
        //         }
        ...
        //                     &csl::NativeScript::from_hex(&script.script_cbor).map_err(
        //                         WError::from_err(
        //                             "CorePallas - add_output - invalid simple script_cbor",
        //                         ),
        //                     )?,
        //                 ))
        //         }
        ...
        //     .next()
        //     .map_err(WError::from_err("CorePallas - add_output - next output"))?;
        ...
        //                             "CorePallas - add_output - invalid coins_per_utxo_size",
        //                         ),
        //                     )?,
        //                 ),
        //             )
        //             .map_err(WError::from_err(
        //                 "CorePallas - add_output - with_asset_and_min_required_coin_by_utxo_cost",
        //             ))?
        //             .build()
        //             .map_err(WError::from_err("CorePallas - add_output - build() (1)"))?
        //     } else {
        //         amount_builder
        //             .with_coin_and_asset(&tx_value.coin(), &tx_value.multiasset().unwrap())
        //             .build()
        //             .map_err(WError::from_err("CorePallas - add_output - build() (2)"))?
        //     }
        // } else {
        //     amount_builder
        //         .with_coin(&tx_value.coin())
        //         .build()
        //         .map_err(WError::from_err("CorePallas - add_output - build() (3)"))?
        // };
        // self.tx_builder
        //     .add_output(&built_output)
        //     .map_err(WError::from_err("CorePallas - add_output - add_output"))?;
        Ok(())
    }
    ...
    pub fn add_collateral(&mut self, collateral: PubKeyTxIn) -> Result<(), WError> {
        ...
        //             WError::from_err("CorePallas - add_collateral - invalid address"),
        //         )?,
        //         &csl::TransactionInput::new(
        //             &csl::TransactionHash::from_hex(&collateral.tx_in.tx_hash).map_err(
        //                 WError::from_err("CorePallas - add_collateral - invalid tx_hash"),
        //             )?,
        ...
        //     )
        //     .map_err(WError::from_err(
        //         "CorePallas - add_collateral - add_regular_input",
        //     ))?;
        Ok(())
    }
    ...
    pub fn add_reference_input(&mut self, ref_input: RefTxIn) -> Result<(), WError> {
        ...
        //         "CorePallas - add_reference_input - invalid_tx_hash",
        //     ))?,
        //     ref_input.tx_index,
        // );
    ...
    pub fn add_pub_key_withdrawal(&mut self, withdrawal: PubKeyWithdrawal) -> Result<(), WError> {
        ...
        //                 "CorePallas - add_pub_key_withdrawal - invalid address",
        //             ))?,
        //         )
        //         .unwrap(),
        //         &csl::BigNum::from_str(&withdrawal.coin.to_string()).map_err(WError::from_err(
        //             "CorePallas - add_collateral - invalid coin as BigNum",
        //         ))?,
        //     )
        //     .map_err(WError::from_err(
        //         "CorePallas - add_pub_key_withdrawal - add()",
        //     ))?;
        Ok(())
    }
    ...
    pub fn add_plutus_withdrawal(
        ...
        //     &to_bignum(0).unwrap(),
        //     &csl::PlutusData::from_hex(&redeemer.data).map_err(WError::from_err(
        //         "CorePallas - add_plutus_withdrawal - invalid redeemer.data",
        //     ))?,
        //     &csl::ExUnits::new(
        //         &to_bignum(redeemer.ex_units.mem).map_err(WError::add_err_trace(
        //             "CorePallas - add_plutus_withdrawal - invalid redeemer memory",
        //         ))?,
        //         &to_bignum(redeemer.ex_units.steps).map_err(WError::add_err_trace(
        //             "CorePallas - add_plutus_withdrawal - invalid redeemer steps",
        //         ))?,
        //     ),
        // );
        ...
        //         &csl::RewardAddress::from_address(
        //             &csl::Address::from_bech32(&withdrawal.address).map_err(WError::from_err(
        //                 "CorePallas - add_plutus_withdrawal - invalid address",
        //             ))?,
        //         )
        //         .unwrap(),
        //         &csl::BigNum::from_str(&withdrawal.coin.to_string()).map_err(WError::from_err(
        //             "CorePallas - add_plutus_withdrawal - invalid coin as BigNum",
        //         ))?,
        //         &csl::PlutusWitness::new_with_ref_without_datum(&csl_script, &csl_redeemer),
        //     )
        //     .map_err(WError::from_err(
        //         "CorePallas - add_plutus_withdrawal - add_with_plutus_witness",
        //     ))?;
        Ok(())
    }
    ...
    pub fn add_simple_script_withdrawal(
        ...
        //         &csl::RewardAddress::from_address(
        //             &csl::Address::from_bech32(&withdrawal.address).map_err(WError::from_err(
        //                 "CorePallas - add_simple_script_withdrawal - invalid reward address",
        //             ))?,
        //         )
        //         .unwrap(),
        //         &csl::BigNum::from_str(&withdrawal.coin.to_string()).map_err(WError::from_err(
        //             "CorePallas - add_simple_script_withdrawal - invalid coin as BigNum",
        //         ))?,
        //         &csl_native_script_source,
        //     )
        //     .map_err(WError::from_err(
        //         "CorePallas - add_simple_script_withdrawal - add_with_native_script",
        //     ))
        Ok(())
    }
    ...
    pub fn add_plutus_mint(&mut self, script_mint: ScriptMint, index: u64) -> Result<(), WError> {
        ...
        //         "CorePallas - add_plutus_mint - invalid redeemer index",
        //     ))?,
        //     &csl::PlutusData::from_hex(&redeemer_info.data).map_err(WError::from_err(
        //         "CorePallas - add_plutus_mint - invalid redeemer_info.data",
        //     ))?,
        //     &csl::ExUnits::new(
        //         &to_bignum(redeemer_info.ex_units.mem).map_err(WError::from_err(
        //             "CorePallas - add_plutus_mint - invalid redeemer_info memory",
        //         ))?,
        //         &to_bignum(redeemer_info.ex_units.steps).map_err(WError::from_err(
        //             "CorePallas - add_plutus_mint - invalid redeemer_info steps",
        //         ))?,
        //     ),
        // );
        ...
        //             WError::from_err("CorePallas - add_plutus_mint - Invalid asset name found"),
        //         )?)
        //         .map_err(WError::from_err(
        //             "CorePallas - add_plutus_mint - invalid asset name",
        //         ))?,
        //         &csl::Int::from_str(&script_mint.mint.amount.to_string()).map_err(
        //             WError::from_err("CorePallas - add_plutus_mint - invalid mint amount "),
        //         )?,
        //     )
        //     .map_err(WError::from_err("CorePallas - add_plutus_mint - add_asset"))?;
        Ok(())
    }
    ...
    pub fn add_native_mint(&mut self, native_mint: SimpleScriptMint) -> Result<(), WError> {
        ...
        //                 &csl::NativeScript::from_hex(&script.script_cbor).map_err(
        //                     WError::from_err("CorePallas - add_native_mint - invalid script_cbor"),
        //                 )?,
        //             )),
        //             &csl::AssetName::new(hex::decode(native_mint.mint.asset_name).map_err(
        //                 WError::from_err(
        //                     "CorePallas - add_native_mint - Invalid asset name found (1)",
        //                 ),
        //             )?)
        //             .map_err(WError::from_err(
        //                 "CorePallas - add_native_mint - invalid asset name (1)",
        //             ))?,
        //             &csl::Int::from_str(&native_mint.mint.amount.to_string()).unwrap(),
        //         )
        //         .map_err(WError::from_err(
        //             "CorePallas - add_native_mint - add_asset (1)",
        //         ))?,
        ...
        //                 &csl::ScriptHash::from_hex(&script.simple_script_hash).map_err(
        //                     WError::from_err(
        //                         "CorePallas - add_native_mint - invalid simple_script_hash",
        //                     ),
        //                 )?,
        //                 &csl::TransactionInput::new(
        //                     &csl::TransactionHash::from_hex(&script.ref_tx_in.tx_hash).map_err(
        //                         WError::from_err("CorePallas - add_native_mint - invalid tx_hash"),
        //                     )?,
        //                     script.ref_tx_in.tx_index,
        //                 ),
        //                 script.script_size,
        ...
        //             &csl::AssetName::new(hex::decode(native_mint.mint.asset_name).map_err(
        //                 WError::from_err(
        //                     "CorePallas - add_native_mint - Invalid asset name found (2)",
        //                 ),
        //             )?)
        //             .map_err(WError::from_err(
        //                 "CorePallas - add_native_mint - invalid asset name (2)",
        //             ))?,
        //             &csl::Int::from_str(&native_mint.mint.amount.to_string()).unwrap(),
        //         )
        //         .map_err(WError::from_err(
        //             "CorePallas - add_native_mint - add_asset (2)",
        //         ))?,
        // };
        Ok(())
    }
    ...
    pub fn add_cert(&mut self, cert: Certificate, index: u64) -> Result<(), WError> {
        ...
        //         .map_err(WError::from_err("CorePallas - add_cert - add (1)"))?,
        ...
        //             .map_err(WError::from_err(
        //                 "CorePallas - add_cert - add_with_plutus_witness",
        //             ))?
        //     }
        ...
        //             .map_err(WError::from_err(
        //                 "CorePallas - add_cert - add_with_native_script",
        //             ))?
        //     }
        // };
        Ok(())
    ...
    pub fn add_vote(&mut self, vote: Vote, index: u64) -> Result<(), WError> {
        ...
        //             .map_err(WError::from_err("CorePallas - add_vote - invalid voter"))?;
        ...
        //                         .map_err(WError::from_err(
        //                             "CorePallas - add_vote - invalid tx_hash (1)",
        //                         ))?,
        //                     vote_type.gov_action_id.tx_index,
        //                 ),
        //                 &voting_procedure,
        //             )
        //             .map_err(WError::from_err("CorePallas - add_vote - add"))?;
        //     }
        ...
        //                     )
        //                     .map_err(WError::from_err(
        //                         "CorePallas - add_vote - invalid tx_hash (2)",
        //                     ))?,
        ...
        //             )
        //             .map_err(WError::from_err(
        //                 "CorePallas - add_vote - add_with_plutus_witness",
        //             ))?;
        //     }
        ...
        //                     )
        //                     .map_err(WError::from_err(
        //                         "CorePallas - add_vote - invalid tx_hash (3)",
        //                     ))?,
        ...
        //             )
        //             .map_err(WError::from_err(
        //                 "CorePallas - add_vote - add_with_native_script",
        //             ))?;
        //     }
        // };
        Ok(())
    ...
    pub fn add_invalid_before(&mut self, invalid_before: u64) -> Result<(), WError> {
        ...
        //         WError::from_err("CorePallas - add_invalid_before - invalid invalid_before"),
        //     )?);
        Ok(())
    }
    ...
    pub fn add_invalid_hereafter(&mut self, invalid_hereafter: u64) -> Result<(), WError> {
        ...
        //         "CorePallas - add_invalid_hereafter - invalid invalid_hereafter",
        //     ))?);
        Ok(())
    }
    ...
    pub fn add_change(
        ...
        //                 "CorePallas - add_change - invalid change_address (1)",
        //             ))?,
        //             &csl::OutputDatum::new_data(
        //                 &csl::PlutusData::from_hex(change_datum.get_inner()).map_err(
        //                     WError::from_err("CorePallas - add_change - invalid change_datum"),
        //                 )?,
        //             ),
        //         )
        //         .map_err(WError::from_err(
        //             "CorePallas - add_change - add_change_if_needed_with_datum",
        //         ))?;
        // } else {
        //     self.tx_builder
        //         .add_change_if_needed(&output_address.map_err(WError::from_err(
        //             "CorePallas - add_change - invalid change_address (2)",
        //         ))?)
        //         .map_err(WError::from_err(
        //             "CorePallas - add_change - add_change_if_needed",
        //         ))?;
        // }
        Ok(())
    }
    ...
    pub fn add_required_signature(&mut self, pub_key_hash: &str) -> Result<(), WError> {
        ...
        //         WError::from_err("CorePallas - add_required_signature - invalid pub_key_hash"),
        //     )?);
        Ok(())
    }
    ...
    pub fn add_metadata(&mut self, metadata: Metadata) -> Result<(), WError> {
        ...
        //             "CorePallas - add_metadata - invalid metadata tag",
        //         ))?,
        //         metadata.metadata,
        //     )
        //     .map_err(WError::from_err(
        //         "CorePallas - add_metadata - add_json_metadatum",
        //     ))?;
        Ok(())
    }
    ...
    pub fn add_script_hash(&mut self, network: Network) -> Result<(), WError> {
        ...
        //     .map_err(WError::from_err(
        //         "CorePallas - add_script_hash - calc_script_data_hash",
        //     ))?;
        Ok(())
    }
    ...
    pub fn build_tx(&mut self, safe_build: bool) -> Result<String, WError> {
        ...
        // }
        // .map_err(WError::from_err("CorePallas - build_tx - build_tx"))?;
