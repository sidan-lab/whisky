...
const inputFile = fs.readFileSync('./packages/whisky-core/pkg/whisky_core.d.ts', 'utf8').split(/\r?\n/);
...
const jsonDefs = fs.readFileSync('./packages/whisky-core/json-gen/output/json-types.d.ts', 'utf8');
fs.writeFile(
  './packages/whisky-core/pkg/whisky-core.d.ts',
  `${inputFile.join('\n')}\n${jsonDefs}`,
  (err) => {
    if (err != null) {
